...
- $P(\theta|data)$: probability of $\theta$ given the data: this is the **posterior distribution** of the parameter $\theta$
...
[$$posterior \propto prior*likelihood$$]{.fragment}
...
Our understanding of a phenomenon after observation $P(hypothesis|data)$ is 

our prior belief $P(hypothesis)$ 

updated by the evidence $P(data|hypothesis)$ 


[$updated~belief \propto prior~belief*current~evidence$]{.fragment}
...
several chains, convergence after burn-in phase

![](convergence.png){fig-align="center"} Source: [D. Valle 2023](https://drvalle1.github.io/20_MCMC_convergence.html){style="font-size: 22px"}
