...
$$\color{turquoise}{\mu}_i \sim  \color{green}{\alpha} \times [ln(Light_{i})- \color{red}{\beta}]^2 + \color{royalblue}{\gamma} + {\tau} \times ln(TWI_i) + Σ V_{i,k} \times \color{mediumpurple}{\psi}_k$$

::::: columns
::: {.column width="50%"}
![](SDM.png){fig-align="center"} [Badouard et all in prep]{style="font-size: 22px"}
:::
